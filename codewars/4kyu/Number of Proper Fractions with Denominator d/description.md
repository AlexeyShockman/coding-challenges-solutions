https://www.codewars.com/kata/55b7bb74a0256d4467000070/javascript
...
_____ 
Если по-простому, то нам надо найти сколько несокращаемых дробей получится из натуральных чисел 1 -> n в числителе и n знаменателе
